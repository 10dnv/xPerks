...
Perks improve these metrics. They do reinforce & strengthen company culture.
Leveling of perks happens at the fastest rate ever thus pressure on keeping brains engaged remains high.

Short answer: Leverage in Battle for Brains.

###  What?
xPerks is available as a solution that rewrites the way company - employee relationship is handled in terms of building trust & fostering long term relationship. This is Step 1 which is focused on getting companies onboard - leveraging the already available databases of companies + the Single Sign-On solution. Adoption of experts will happen in-bulk during this step.

For the Step 2 xPerks will evolve to a platform inter-connecting companies and experts in an X to X fashion. This is where focus will be on transparency and loialty recognition will play a pivotal point.
...
May  2024: V1.1 UI/UX overhaul, baseline of selectable perks available on main-net
...
<img src="artifacts/8.png" alt="Redeem Points" width="600"/>

- Transaction History (MvsX):
<img src="artifacts/9.png" alt="Transaction History" width="600"/>
